        ...
        <main className="flex flex-1 flex-col md:flex-row items-center justify-center px-8 mt-4">
          <div className="flex-1 md:text-left text-center h-full">
            <h1 className="text-4xl md:text-6xl font-bold">
              Welcome to <span className="text-black">Snapchat</span>
            </h1>
            <p className="mt-4 text-xl font-semibold">
              Share moments with friends and family and explore the world around
              you.
            </p>
            <div className="mt-4">
              <p className="mt-2 text-lg font-semibold">
                Chat with friends and family ..what are you waiting for?
              </p>
            </div>
            {!session ? (
              <Button
